...
import com.adopcion.adopcionmascota.Repository.UsuarioRepository;
...
public class UsuarioService {
    ...
    public Usuario guardarUsuario(Usuario usuario){
        ...
        RolUsuario rol = rolUsuarioRepository.findById(usuario.getRolUsuario().getIdRol()).orElse(null);
        if(rol == null){
            return null;
        }
